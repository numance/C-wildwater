...
void propager_fuites(Acteur *acteur, double vol_entree, double *fuites_totales); // calcul nbr fils acteur / l'eau et calcule pour chaque fils et ses fils lui meme... (recursivité)

double calculer_fuites_usine(char *id_usine, AVLUsine *racine_usines, AVLActeur *racine_index_acteurs); // retrouve l'usine et ses info ainsi que strct acteur et lance propagation
...
int exporter_fuites_usine(AVLUsine *racine_usines, char *id_usine, char *chemin_sortie_dat, double leaks); // exporte dzns historique les données demandé sauf si usine non trouvé
